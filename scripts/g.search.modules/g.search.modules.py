...
def _search_module(
    ...
    menudata_file = open(filename, "r", encoding="utf-8")
    ...
    if os.getenv("GRASS_ADDON_BASE"):
        ...
        if os.path.isfile(filename_addons):
            addon_menudata_file = open(filename_addons, "r", encoding="utf-8")
    ...
    if os.path.isfile(filename_addons_s):
        addon_menudata_file_s = open(filename_addons_s, "r", encoding="utf-8")
