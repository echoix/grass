...
1|2|0"""
    ...
    def setUpClass(cls):
        ...
        cls._create_test_vector("test_square2", cls.square2_coords)  # Partially overlaps with square1
        cls._create_test_vector("test_square3", cls.square3_coords)  # No overlap with square1
