...
class HtmlCell(wx.Object):
    ...
    def FindCellByPos(self, x, y, flags=...):
        """
...
class HtmlContainerCell(HtmlCell):
    ...
    def SetBorder(self, clr1, clr2, border=...):
        """
    ...
    def SetIndent(self, i, what, units=...):
        """
...
class HtmlColourCell(HtmlCell):
    ...
    foreground.
    """
    def __init__(self, clr, flags=...) -> None:
        """
        HtmlColourCell(clr, flags=HTML_CLR_FOREGROUND)
...
class HtmlTag:
    ...
    def GetParam(self, par, with_quotes=...):
        """
...
class HtmlWindow(wx.ScrolledWindow, HtmlWindowInterface):
    ...
    def SetStandardFonts(self, size=..., normal_face=..., fixed_face=...):
        """
...
class HtmlDCRenderer(wx.Object):
    ...
    def SetHtmlText(self, html, basepath=..., isdir=...):
        """
...
class HtmlEasyPrinting(wx.Object):
    ...
    def PreviewText(self, htmltext, basepath=...):
        """
    ...
    def PrintText(self, htmltext, basepath=...):
        """
...
class HtmlHelpFrame(wx.Frame):
    ...
    def Create(self, parent, id=..., title=..., style=..., config=..., rootpath=...):
        """
...
class HtmlHelpDialog(wx.Dialog):
    ...
    def Create(self, parent, id=..., title=..., style=...):
        """
...
class HtmlHelpWindow(wx.Window):
    ...
    def Create(self, parent, id=..., pos=..., size=..., style=..., helpStyle=...):
        """
    ...
    def KeywordSearch(self, keyword, mode=...):
        """
...
class HtmlModalHelp:
    ...
    dialog.
    """
    def __init__(self, parent, helpFile, topic=..., style=...) -> None:
        """
        HtmlModalHelp(parent, helpFile, topic=wx.EmptyString, style=HF_DEFAULT_STYLE|HF_DIALOG|HF_MODAL)
...
class SimpleHtmlListBox(HtmlListBox, wx.ItemContainer):
    ...
    def Create(self, parent, id=..., pos=..., size=..., choices=..., style=..., validator=..., name=...):
        """
