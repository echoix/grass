...
def main():
    ...
    path_r_mapcalc = "/home/e-c/grass/dist.x86_64-pc-linux-gnu/bin/r.mapcalc"
    print("Edouard_thumb_before_assert")
    assert os.path.isfile(path_r_mapcalc)
    print("Edouard_thumb_after_assert")
    tmp_grad_abs = "tmp_grad_abs_%d_%d" % (pid, ts)
    tmp_grad_rel = "tmp_grad_rel_%d_%d" % (pid, ts)
