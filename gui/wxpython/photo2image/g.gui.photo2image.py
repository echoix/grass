...
def main():
    ...
    if options["group"]:
        ...
        gs.fatal(_("Please provide a group name to process"))

    if options["raster"]:
        raster = options["raster"]
    else:
        gs.fatal(_("Please provide a raster map name to process"))

    if options["camera"]:
        camera = options["camera"]
    else:
        gs.fatal(_("Please provide a camera name (generated by i.ortho.camera)"))
