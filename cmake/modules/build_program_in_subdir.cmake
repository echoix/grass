...
# PURPOSE:    CMake macro to build a grass executable (program) under sub
#             directory which is passed as argument to macro
...
macro(build_program_in_subdir dir_name)
  ...
  if("NAME" IN_LIST extra_args)
    ...
    build_program(
      NAME ${pgm_name} SRCDIR ${CMAKE_CURRENT_SOURCE_DIR}/${dir_name} ${ARGN}
    )
  endif()
endmacro()
