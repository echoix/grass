...
# PURPOSE:    This is the main function that builds all grass libraries
#             (prefixed with grass_) and grass executables. This cmake function
#             is tailored to meet requirement of grass gnu make rules
...
function(build_module)
  ...
  if(G_EXE)
    ...
    generate_export_header(
      ${G_NAME} STATIC_DEFINE "STATIC_BUILD" EXPORT_FILE_NAME
      ${export_file_name}
    )
  endif()
  ...
  target_compile_definitions(
    ${G_NAME} PRIVATE "-DPACKAGE=\"${package_define}\""
  )
  ...
  set(RUN_HTML_DESC TRUE)
  # Auto set if to run RUN_HTML_DESC
  if(G_EXE)
    set(RUN_HTML_DESC TRUE)
    if(G_RUNTIME_OUTPUT_DIR)
      set(RUN_HTML_DESC FALSE)
    endif()
    # g.parser and some others does not have --html-description.
    if(${G_NAME} IN_LIST NO_HTML_DESC_TARGETS)
      set(RUN_HTML_DESC FALSE)
    endif()
  else()
    set(RUN_HTML_DESC FALSE)
  ...
  if(WITH_DOCS)
    ...
    set(html_desc_argument "--html-description")
    if(RUN_HTML_DESC)
      set(html_desc_command ${G_NAME}${PGM_EXT} "--html-description")
    else()
      set(html_desc_command ${CMAKE_COMMAND} -E touch
    ...
    add_custom_command(
      ...
      COMMAND ${grass_env_command} ${CMAKE_COMMAND} -E chdir ${G_SRCDIR}
              ${html_desc_command} > ${TMP_HTML_FILE}
      COMMAND ${grass_env_command} ${CMAKE_COMMAND} -E chdir ${G_SRCDIR}
